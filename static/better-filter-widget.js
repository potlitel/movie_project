function BetterFilterWidget(field_name){
    ...
    function selectItem(){
        ...
        updateSelectedDisplay();
        toast('Has seleccionado a '+ selected_item.text());
        // BFWTimer.report(arguments.callee.name);
    }
    function toast(msg){
    ...
    var filter_input = $('<input class="item-filter" type="text" placeholder="Filtrar..."/>');
    var item_count = 0;
    // Layout
    ...
    bfw_wrap.append( '<div class="title title-available">'+field_name+' disponibles</div><div class="title title-selected">'+field_name+' seleccionados</div><div style="clear:both"/>');
